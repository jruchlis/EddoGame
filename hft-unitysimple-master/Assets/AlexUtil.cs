...
{        
    ...
    public static void DgRPC(this GameObject obj, string functionName, RPCMode target, params object[] args)
    {
        ...
        {
            obj.networkView.RPC(functionName, target, args);
...
{	
	...
	public static void DrawText(Vector2 position, string text, int fontSize, Color fontColor)
	{
		DrawText( position,  text,  fontSize,  fontColor, "");
	}
